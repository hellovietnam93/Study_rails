...
$(document).ready(function(){$.AdminLTE.layout.activate()}),$(document).on("page:load",function(){var a;a=$.AdminLTE.options,a.sidebarPushMenu&&$.AdminLTE.pushMenu.activate(a.sidebarToggleSelector),$.AdminLTE.layout.activate()});
